...
content.gsub!(/Необходимо научиться /, 'Научитесь')

content.gsub!(/Довольно часто /, 'Часто')

content.gsub!(/Необходимо проводить /, 'Проводите')

content.gsub!(/Необходимо уделить внимание /, 'Уделите внимание')
